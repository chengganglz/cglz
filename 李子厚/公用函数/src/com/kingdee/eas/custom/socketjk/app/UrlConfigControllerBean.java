...
public class UrlConfigControllerBean extends AbstractUrlConfigControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.socketjk.app.UrlConfigControllerBean");
}