 ...
 * output class name
 */
public class UrlConfigListUI extends AbstractUrlConfigListUI
{
    private static final Logger logger = CoreUIObject.getLogger(UrlConfigListUI.class);
    
    /**
     * output class constructor
     */
    public UrlConfigListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.socketjk.client.UrlConfigTreeEditUI.class.getName();
    }
