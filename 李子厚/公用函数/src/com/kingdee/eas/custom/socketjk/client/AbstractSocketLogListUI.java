 ...
 * output class name
 */
public abstract class AbstractSocketLogListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSocketLogListUI.class);
    ...
    protected ActionStartServer actionStartServer = null;
    public final static String STATUS_VIEW = "VIEW";
    /**
     * output class constructor
     */
    public AbstractSocketLogListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSocketLogListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.socketjk.app", "SocketLogQuery");
        //actionAddNew
        ...
        // kDWorkButton1
        this.kDWorkButton1.setAction((IItemAction)ActionProxyFactory.getProxy(actionStartServer, new Class[] { IItemAction.class }, getServiceContext()));		
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.socketjk.app.SocketLogListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("socketData"));
        sic.add(new SelectorItemInfo("errMsg"));
        sic.add(new SelectorItemInfo("dataType.name"));
        return sic;
	...
	public RequestContext prepareActionStartServer(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
	...
	public boolean isPrepareActionStartServer() {
    	return false;
    }
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractSocketLogListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSocketLogListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }

    /**
     * output ActionStartServer class
     */     
    protected class ActionStartServer extends ItemAction {     
        ...
        public ActionStartServer(IUIObject uiObject)
        {     
		super(uiObject);     
        
            String _tempStr = null;
            _tempStr = resHelper.getString("ActionStartServer.SHORT_DESCRIPTION");
            this.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionStartServer.LONG_DESCRIPTION");
            this.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionStartServer.NAME");
            this.putValue(ItemAction.NAME, _tempStr);
        }
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSocketLogListUI.this, "ActionStartServer", "actionStartServer_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.socketjk.client", "SocketLogListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.socketjk.client.SocketLogEditUI.class.getName();
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","socketData","errMsg","dataType.name"};
    }



	protected String getTDFileName() {
    	return "/bim/custom/socketjk/SocketLog";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.socketjk.app.SocketLogQuery");
	}
