 ...
 * output class name
 */
public abstract class AbstractSocketLogListUIHandler extends com.kingdee.eas.framework.app.CoreBillListUIHandler

{
	...
	public void handleActionStartServer(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionStartServer(request,response,context);
	}
	protected void _handleActionStartServer(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
}