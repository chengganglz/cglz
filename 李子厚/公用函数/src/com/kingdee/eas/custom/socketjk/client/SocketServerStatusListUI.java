 ...
 * output class name
 */
public class SocketServerStatusListUI extends AbstractSocketServerStatusListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SocketServerStatusListUI.class);
    
    /**
     * output class constructor
     */
    public SocketServerStatusListUI() throws Exception
    {
        super();
    }
