...
public class SocketLogControllerBean extends AbstractSocketLogControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.socketjk.app.SocketLogControllerBean");
}