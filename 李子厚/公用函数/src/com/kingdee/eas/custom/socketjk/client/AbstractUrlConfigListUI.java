 ...
 * output class name
 */
public abstract class AbstractUrlConfigListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractUrlConfigListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractUrlConfigListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractUrlConfigListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractUrlConfigListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.socketjk.app", "UrlConfigQuery");
        // CoreUI
        ...
        this.tblMain.setFormatXml(resHelper.translateString("tblMain",tblMainStrXML));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","name","number","description","simpleName","createTime","creator.name","lastUpdateTime","lastUpdateUser.name","treeid.id","FICompany.name","ip","port","urlType","isUseHeartbeatMsg","HeartbeatMsgTime","isWrite","timeOut","IsUse","ReTranTimes","Charset","headLength"});
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.socketjk.app.UrlConfigListUIHandler";
	}
...
protected FilterInfo getDefaultFilterForTree() {
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.socketjk.client", "UrlConfigListUI");
    }
