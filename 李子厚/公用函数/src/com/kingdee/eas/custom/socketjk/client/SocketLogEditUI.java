 ...
 * output class name
 */
public class SocketLogEditUI extends AbstractSocketLogEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SocketLogEditUI.class);
    
    /**
     * output class constructor
     */
    public SocketLogEditUI() throws Exception
    {
