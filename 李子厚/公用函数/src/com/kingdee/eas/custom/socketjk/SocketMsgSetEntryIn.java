...
public class SocketMsgSetEntryIn extends CoreBillEntryBase implements ISocketMsgSetEntryIn
{
    public SocketMsgSetEntryIn()
    {
        super();
        registerInterface(ISocketMsgSetEntryIn.class, this);
    }
    public SocketMsgSetEntryIn(Context ctx)
    {
        super(ctx);
        registerInterface(ISocketMsgSetEntryIn.class, this);
    }
    ...
    private SocketMsgSetEntryInController getController() throws BOSException
    {
        return (SocketMsgSetEntryInController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSocketMsgSetEntryInInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSocketMsgSetEntryInInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSocketMsgSetEntryInInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSocketMsgSetEntryInCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSocketMsgSetEntryInCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSocketMsgSetEntryInCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
