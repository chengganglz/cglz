 ...
 * output class name
 */
public class SocketServerStatusEditUI extends AbstractSocketServerStatusEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SocketServerStatusEditUI.class);
    
    /**
     * output class constructor
     */
    public SocketServerStatusEditUI() throws Exception
    {
        super();
    }
    /**
