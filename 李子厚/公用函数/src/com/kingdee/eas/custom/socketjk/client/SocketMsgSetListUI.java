 ...
 * output class name
 */
public class SocketMsgSetListUI extends AbstractSocketMsgSetListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SocketMsgSetListUI.class);
    
    /**
     * output class constructor
     */
    public SocketMsgSetListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.socketjk.client.SocketMsgSetTreeEditUI.class.getName();
    }
