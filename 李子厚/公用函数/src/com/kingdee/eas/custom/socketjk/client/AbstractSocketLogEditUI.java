 ...
 * output class name
 */
public abstract class AbstractSocketLogEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSocketLogEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contsocketData;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer conterrMsg;
    ...
    protected com.kingdee.bos.ctrl.swing.KDScrollPane scrollPanesocketData;
    protected com.kingdee.bos.ctrl.swing.KDTextArea txtsocketData;
    protected com.kingdee.bos.ctrl.swing.KDScrollPane scrollPaneerrMsg;
    protected com.kingdee.bos.ctrl.swing.KDTextArea txterrMsg;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtdataType;
    protected com.kingdee.eas.custom.socketjk.SocketLogInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSocketLogEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSocketLogEditUI.class.getName());
        ...
        this.contsocketData = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.conterrMsg = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.scrollPanesocketData = new com.kingdee.bos.ctrl.swing.KDScrollPane();
        this.txtsocketData = new com.kingdee.bos.ctrl.swing.KDTextArea();
        this.scrollPaneerrMsg = new com.kingdee.bos.ctrl.swing.KDScrollPane();
        this.txterrMsg = new com.kingdee.bos.ctrl.swing.KDTextArea();
        this.prmtdataType = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        this.contsocketData.setName("contsocketData");
        this.conterrMsg.setName("conterrMsg");
        ...
        this.scrollPanesocketData.setName("scrollPanesocketData");
        this.txtsocketData.setName("txtsocketData");
        this.scrollPaneerrMsg.setName("scrollPaneerrMsg");
        this.txterrMsg.setName("txterrMsg");
        this.prmtdataType.setName("prmtdataType");
        // CoreUI		
        ...
        // contsocketData		
        this.contsocketData.setBoundLabelText(resHelper.getString("contsocketData.boundLabelText"));		
        this.contsocketData.setBoundLabelLength(100);		
        this.contsocketData.setBoundLabelUnderline(true);		
        this.contsocketData.setVisible(true);
        // conterrMsg		
        this.conterrMsg.setBoundLabelText(resHelper.getString("conterrMsg.boundLabelText"));		
        this.conterrMsg.setBoundLabelLength(100);		
        this.conterrMsg.setBoundLabelUnderline(true);		
        this.conterrMsg.setVisible(true);
        // contdataType		
        ...
        // scrollPanesocketData
        // txtsocketData		
        this.txtsocketData.setVisible(true);		
        this.txtsocketData.setRequired(false);		
        this.txtsocketData.setMaxLength(8000);		
        this.txtsocketData.setEnabled(false);
        // scrollPaneerrMsg
        // txterrMsg		
        this.txterrMsg.setVisible(true);		
        this.txterrMsg.setRequired(false);		
        this.txterrMsg.setMaxLength(8000);		
        this.txterrMsg.setEnabled(false);
        // prmtdataType		
        this.prmtdataType.setQueryInfo("com.kingdee.eas.custom.socketjk.app.UrlConfigQuery");		
        this.prmtdataType.setVisible(true);		
        this.prmtdataType.setEditable(true);		
        this.prmtdataType.setDisplayFormat("$name$");		
        this.prmtdataType.setEditFormat("$number$");		
        this.prmtdataType.setCommitFormat("$number$");		
        this.prmtdataType.setRequired(false);
        		EntityViewInfo eviprmtdataType = new EntityViewInfo ();
		eviprmtdataType.setFilter(com.kingdee.eas.framework.FrameWorkUtils.getF7FilterInfoByAuthorizedOrg(com.kingdee.eas.basedata.org.OrgType.getEnum("Company"),"FICompany.id"));
		prmtdataType.setEntityViewInfo(eviprmtdataType);
					
        		prmtdataType.addSelectorListener(new SelectorListener() {
			com.kingdee.eas.custom.socketjk.client.UrlConfigListUI prmtdataType_F7ListUI = null;
			public void willShow(SelectorEvent e) {
				if (prmtdataType_F7ListUI == null) {
					try {
						prmtdataType_F7ListUI = new com.kingdee.eas.custom.socketjk.client.UrlConfigListUI();
					} catch (Exception e1) {
						e1.printStackTrace();
					}
					HashMap ctx = new HashMap();
					ctx.put("bizUIOwner",javax.swing.SwingUtilities.getWindowAncestor(prmtdataType_F7ListUI));
					prmtdataType_F7ListUI.setF7Use(true,ctx);
					prmtdataType.setSelector(prmtdataType_F7ListUI);
				}
			}
		});
					
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtsocketData,txterrMsg,prmtdataType}));
    ...
    public void initUIContentLayout()
    {
        ...
        contNumber.setBounds(new Rectangle(38, 67, 270, 19));
        this.add(contNumber, new KDLayout.Constraints(38, 67, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contBizDate.setBounds(new Rectangle(350, 67, 270, 19));
        this.add(contBizDate, new KDLayout.Constraints(350, 67, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contDescription.setBounds(new Rectangle(679, 67, 270, 19));
        this.add(contDescription, new KDLayout.Constraints(679, 67, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAuditor.setBounds(new Rectangle(38, 528, 270, 19));
        this.add(contAuditor, new KDLayout.Constraints(38, 528, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contsocketData.setBounds(new Rectangle(44, 168, 954, 170));
        this.add(contsocketData, new KDLayout.Constraints(44, 168, 954, 170, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        conterrMsg.setBounds(new Rectangle(41, 364, 957, 146));
        this.add(conterrMsg, new KDLayout.Constraints(41, 364, 957, 146, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contdataType.setBounds(new Rectangle(40, 121, 270, 19));
        this.add(contdataType, new KDLayout.Constraints(40, 121, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
        ...
        //contsocketData
        contsocketData.setBoundEditor(scrollPanesocketData);
        //scrollPanesocketData
        scrollPanesocketData.getViewport().add(txtsocketData, null);
        //conterrMsg
        conterrMsg.setBoundEditor(scrollPaneerrMsg);
        //scrollPaneerrMsg
        scrollPaneerrMsg.getViewport().add(txterrMsg, null);
        //contdataType
        contdataType.setBoundEditor(prmtdataType);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("socketData", String.class, this.txtsocketData, "text");
		dataBinder.registerBinding("errMsg", String.class, this.txterrMsg, "text");
		dataBinder.registerBinding("dataType", com.kingdee.eas.custom.socketjk.UrlConfigInfo.class, this.prmtdataType, "data");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.socketjk.app.SocketLogEditUIHandler";
	}
    ...
    {
        super.onShow();
        this.txtsocketData.requestFocusInWindow();
    }
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.socketjk.SocketLogInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("socketData", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("errMsg", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
        	...
        	sic.add(new SelectorItemInfo("dataType.id"));
        	sic.add(new SelectorItemInfo("dataType.number"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.socketjk.client", "SocketLogEditUI");
    }
    /**
