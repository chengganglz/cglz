...
with(imp){ 
	...
	// socketMsg = "0203CCCW0420190425140857CCCWDL11940004200        192021021100        TESTSHIHUI2019042501X190425002          L101DD11                                              00350015040000002800020190425140919   0 "
	/* //发送电文示例
	...
	*/
	...
	var strBizDate=PublicBaseUtil.substringByte(socketMsg,"GBK" ,185,14); //业务日期  从MES获取
	...
	var strStockNo=PublicBaseUtil.substringByte(socketMsg,"GBK" ,199,3);;//仓库编码  从MES获取	
	...
	*/
	...
	var zl=PublicBaseUtil.substringByte(socketMsg,"GBK" ,175,10);//重量  从MES获取
