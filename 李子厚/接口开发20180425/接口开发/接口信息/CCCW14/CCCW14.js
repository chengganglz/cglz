...
with(imp){ 
	...
	var temp_thjg=PublicBaseUtil.substringByte(socketMsg,"GBK" ,161,12);//  从MES获取
	if(temp_thjg!=null){
	...
	try
	{
		thjg=new BigDecimal(temp_thjg).divide(new BigDecimal('100'));
	}catch(e){
	...
	if(isSucess){
		...
		//}else{
			...
			//if(isSucess){
				...
				// 字段名称 唯一标识,编码,名称,创建id,创建时间,控制单元,出口卷号,合同号,合约号,机组号,重量,生产时间,是否入库,电文号,电文类型,退货价格
				// 值 id,rjh,hth,'256c221a-0106-1000-e000-10d7c0a813f413B7DE7F',fcreatetimestr,'00000000-0000-0000-0000-000000000000CCE7AED4',rjh,hth,hyh,cbzxNo,bgQty,scsj,0,dwh,4,thjg
				sql = "insert into CT_CUS_JZSCCCJL(fid,FNUMBER,FNAME_L2,fcreatorid,fcreatetime,fcontrolunitid,CFCKJH,CFHTH,CFHYH,CFJZH,CFZL,CFSCSJ,CFWLID,CFSFRK,CFDWH,CFDWLX) values('"+id+"','"+fnumber+"','"+fnumber+"','256c221a-0106-1000-e000-10d7c0a813f413B7DE7F',to_date('"+fcreatetimestr+"'),'00000000-0000-0000-0000-000000000000CCE7AED4','"+rjh+"','"+hth+"','"+hyh+"','"+cbzxNo+"','"+bgQty+"',to_date('"+scsj+"'),'0','"+dwh+"',4,'"+thjg+"')"
